"""projectcurd52pm URL Configuration
...
from modelapp.views import HomeView,InsertInput,InsertView,DisplayView,DeleteView,DeleteInputView,UpdateView,UpdateInputView
